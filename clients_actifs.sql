-- Clients actifs - VERSION AVEC HISTORIQUE ET ENCOURS
...
WITH CreditsParClient AS (
    SELECT 
        ...
        -- Calcul de l'encours actuel : seulement les crédits non soldés
